...
import { literalGridDefault } from '../helpers/defaults.js';
import {
...
const BLANK_COLUMNS: GridColumn[] = Array.from({ length: 26 }, (_, index) => ({
...
function enrichGridColumns(
  ...
  return columns.map((column) => {
    ...
    const target = relation?.targetFileId
      ...
      : undefined;
    const defaultValue = literalGridDefault(
 ...
 */
export function spreadsheetColumns(columns: GridColumn[]) {
