...
import type { ExplorerActionResult } from '../events/actions.js';
import { dispatchExplorerAction } from '../events/actions.js';
import { mapCatalogToExplorer } from './model.js';
import { normalizePhysicalName } from './model.js';

//The explorer service value exported for module callers
export const EXPLORER_SERVICE = 'tabular.explorer';

/**
 * Provide explorer plugin operations through one service boundary.
 */
export class ExplorerPluginService {
  //The name state retained by this class instance
  public readonly name = EXPLORER_SERVICE;

  /**
   * Create a ExplorerPluginService instance.
   */
  public constructor(
   ...
   */
  public plan(principal: BrowserMutationPrincipal, action: ExplorerCapabilityAction) {
