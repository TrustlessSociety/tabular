...
//The outbox row contract exported for module callers
...
//The realtime target contract exported for module callers
...
/**
 * Provide realtime persistence operations.
 */
export class RealtimeRepository {
  /**
   * Create a RealtimeRepository instance.
   */
  ...
  /**
   * Handle the target operation.
   */
  public async target(connectionId: string, fileId: string) {
