...
00001 Froze on 2026-07-31. The text-only creative reconstruction preserves the
approved wireframe direction through r005 Round 13 (2026-07-30).
...
3. [Spreadsheet canvas and column configuration](tabular-grid-and-column-spec.md)
   — the grid, editing, errors, reordering, column settings, and relationships.
...
5. [File explorer, new file, import, and table settings](tabular-files-import-and-settings-spec.md)
   — folder-first discovery and all file-level flows.
...
`wireframes/r005-spreadsheet-file-explorer/`, plus the current Tabular research
...
- Reconcile r005's file-first visual language with the accepted
