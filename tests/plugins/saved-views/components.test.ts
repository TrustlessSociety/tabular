...
//client
import type { SavedView } from '../../../src/plugins/saved-views/helpers/contracts.js';
import { SavedViewsDialog } from '../../../src/plugins/saved-views/components/saved-views-dialog.js';
