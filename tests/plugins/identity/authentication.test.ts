...
//client
import type { PostgreSqlLoginClient } from '../../../src/plugins/identity/helpers/postgresql-login.js';
import { PostgreSqlIdentityProvider } from '../../../src/plugins/identity/helpers/postgresql-login.js';
import {
  renderPostgreSqlLogin,
  renderSignedInAccount
} from '../../../src/plugins/identity/views/authentication.js';
