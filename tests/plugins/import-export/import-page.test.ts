...
import { ImportPage } from '../../../src/plugins/import-export/views/import-page.js';

const pageSource = readFileSync(new URL('../../../src/plugins/import-export/views/import-page.tsx', import.meta.url), 'utf8');
